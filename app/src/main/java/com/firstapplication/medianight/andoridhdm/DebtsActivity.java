...
//Klasse für die Activity mit der Liste der Schulden.
public class DebtsActivity extends ListActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
          /*
        Beim Aufruf wird die Debts Layout Datei als View genommen.
        ...
        TextView ScreenDate = (TextView)findViewById(R.id.text_date_debts);
        ScreenDate.setText(currentDate);
        datasource = new DataSource(this);
        datasource.open();

        TextView textviewtotal = (TextView)findViewById(R.id.text_debts_list_total);
        TextView textviewmain = (TextView)findViewById(R.id.text_debts);
        ...
        // Bei Long-Click wird die Methode deleteDebts() aufgerufen. Anschließend wird die Liste erneut befüllt.
        listView.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                String debtsDel = ((TextView) arg1.findViewById(android.R.id.text1)).getText().toString();
                Log.d("StringTest1", debtsDel);
                String debtsLike = debtsDel.substring(3,5);
                Log.d("StringTest", debtsLike);

                datasource.deleteDebts(debtsLike);
    ...
    // Befüllt die Liste mit den Daten durch Aufruf der Methode getAllDebts().
    public void populateList(){

        listView = (ListView)findViewById(android.R.id.list);
        listView.setLongClickable(true);

        List<DebtsModel> values = datasource.getAllDebts();

        ArrayAdapter<DebtsModel> adapter = new ArrayAdapter<DebtsModel>(this, android.R.layout.simple_list_item_1, values);
        setListAdapter(adapter);

        TextView textView = (TextView) findViewById(R.id.editText_debts_amount);
        String debtsSumView = datasource.getDebtsSum().toStringDebtsSum();
        textView.setText("- " + debtsSumView + "€");
    }
